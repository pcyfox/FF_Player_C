package com.taike.module_recoder.ui.activity
...
import com.taike.lib_ffmpeg.FFPlayer
import com.taike.lib_ffmpeg.PlayState
import com.taike.module_recoder.R
import com.taike.module_recoder.audio.MediaConstants
import com.taike.module_recoder.audio.AudioRecorder
...
class MediaRecorderActivity : AppCompatActivity() {
    ...
    // private val url = "rtsp://admin:taike@2020@192.168.28.42:554/cam/realmonitor?channel=1&subtype=0&unicast=true&proto=Onvif"

    //private val url = "rtsp://192.168.43.45:1935/1"
