...
/**
 * Frees the given encryption createVideoCodec info object.  This MUST NOT be used to free
...
/**
 * Allocates and initializes side data that holds a copy of the given encryption
 * createVideoCodec info.  The resulting pointer should be either freed using av_free or
